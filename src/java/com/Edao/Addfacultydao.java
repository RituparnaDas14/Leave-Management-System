...
private static Addfacultydao ld=null;
  ...
  PreparedStatement ps = c.prepareStatement("insert into staff(email,password,name,mobile,gender,address,city,state,designation,department,joiningdate,dob,category) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
